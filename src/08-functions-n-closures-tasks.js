...
function logger(func, logFunc) {
  return function desc(...arg) {
    logFunc(`${func.name}(${arg.map((e) => JSON.stringify(e))}) starts`);
    const res = func(...arg);
    logFunc(`${func.name}(${arg.map((e) => JSON.stringify(e))}) ends`);
    return res;
  };
}
